...
export const AccessDeniedState: React.FC = () => {
  ...
  return (
    <div className="min-h-[70vh] bg-surface-subtle flex flex-col justify-center items-center px-4 py-12">
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm max-w-md w-full text-center space-y-4">
        <div className="mx-auto w-12 h-12 bg-red-50 text-red-600 rounded-full flex items-center justify-center border border-red-200">
